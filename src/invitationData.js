...
export const INVITATION = {
  ...
  copy: {
    en: {
      ...
      photoCaption: 'A warm welcome to our dear family and friends',
      childhoodQuote: 'We wish our little ones a peaceful, happy sleep',
    ...
    ar: {
      ...
      rsvpEdit: 'تعديل الرد',
      closing: 'بكل حبنا',
      photoCaption: 'أهلاً وسهلاً بأحبابنا',
