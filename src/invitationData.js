...
export const WELCOME = {
  ar: 'أهلاً وسهلاً بأحبابنا ❤️',
  en: 'A warm welcome to our dear family and friends ❤️',
}

export const CHILDHOOD_QUOTE = {
  ar: 'نتمنى نوماً هنيئاً لأطفالنا ✨',
  en: 'We wish our little ones a peaceful, happy sleep ✨',
}
...
export const INVITATION = {
  ...
  copy: {
    en: {
      ...
      inviteLine: 'With happy hearts, we would love you to celebrate with our family ❤️',
      ...
      rsvpYes: 'Yes, we will be there with love ❤️',
      rsvpNo: 'We send our love, and we are sorry to miss it',
      rsvpMessage: 'A little message (optional)',
      rsvpMessagePh: 'A warm word for Mohamed & Miss S…',
      rsvpSubmit: 'Submit',
      rsvpSending: 'Sending…',
      rsvpError: 'Something went wrong. Please try again.',
      rsvpThanksYes: 'We cannot wait to see you ❤️',
      rsvpThanksNo: 'You remain in our hearts ❤️',
      rsvpReceived:
      ...
      rsvpThanks: 'With all our love, ❤️',
      rsvpEdit: 'Edit response',
      closing: 'With all our love ❤️',
      photoCaption: 'A warm welcome to our dear family and friends ❤️',
    ...
    ar: {
      ...
      inviteLine: 'بكل قلوبنا، يسعدنا أن تشاركونا فرحتنا مع العيلة ❤️',
      ...
      rsvpYes: 'نعم، سنحضر بكل حب ❤️',
      rsvpNo: 'نرسل حبنا، ونعتذر عن الحضور',
      rsvpMessage: 'كلمة لطيفة (اختياري)',
      rsvpMessagePh: 'كلمة دافية لمحمد والأنسه S…',
      rsvpSubmit: 'إرسال',
      rsvpSending: 'جارٍ الإرسال…',
      rsvpError: 'حدث خطأ، حاولوا مرة أخرى.',
      rsvpThanksYes: 'ننتظركم بكل شوق ❤️',
      rsvpThanksNo: 'ستبقون في قلوبنا ❤️',
      rsvpReceived:
      ...
      rsvpThanks: 'بكل حبنا، ❤️',
      rsvpEdit: 'تعديل الرد',
      closing: 'بكل حبنا ❤️',
      photoCaption: 'أهلاً وسهلاً بأحبابنا ❤️',
